 ...
 */
 ...
 //--------------------------------------
   ...
   private void initSlots() {
     ...
     // Aligned 4 consecutive pieces - 3 offset horizontally
     int horizontalWins = NUMBER_OF_ROWS * (NUMBER_OF_COLUMNS - 3);
     // Aligned 4 consecutive pieces - 3 offset vertically
     int verticalWins = NUMBER_OF_COLUMNS * (NUMBER_OF_ROWS - 3);
     // Diagonal win if there is enought room to fit 3 consecutive pieces
     // symetrical - down left/down right valid starting points are
     // NUMBER_OF_COLUMNS -3 * NUMBER_OF_ROWS -3 * 2
